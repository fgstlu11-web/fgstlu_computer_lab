...
| **4. 網站黑白名單** | **Pi-hole (開源)** | 網路層級統一過濾網域，阻斷違規娛樂網站，防止學生竄改 DNS。 | Pi-hole 儘支持Linux環境，考慮windows環境替代方案，如 https://github.com/AdguardTeam/Adguardhome |
| **5. 軟體安裝申請** | Microsoft Forms + 靜默安裝 | 數位化表單審核，配合批次指令更新至映像檔。 | 無需測試 |
